# strategies/exit_dte_2.py
# Family 4 — DTE threshold variant: 2 DTE
...
META = {
    ...
    'id':         'dte_2',
    'name':       'DTE 2 exit',
    'description':'Exit at EOD when 2 or fewer calendar days remain to expiry.',
    'params': [
        {'key': 'dteDays',     'label': 'Exit at DTE <=',         'default': 2,    'min': 0,  'max': 60,  'step': 1},
