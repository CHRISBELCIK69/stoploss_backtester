# strategies/exit_delta_050.py
# Family 3 — Delta threshold variant: 0.5
...
META = {
    ...
    'needs_greeks': True,
    'id':           'delta_050',
    'name':         'Delta 0.50 exit',
    'description':  'Exit when |delta| reaches 0.50. Standard delta management level.',
    'params': [
        {'key': 'deltaThreshold', 'label': 'Delta threshold',    'default': 0.5, 'min': 0.05, 'max': 0.95, 'step': 0.05},
